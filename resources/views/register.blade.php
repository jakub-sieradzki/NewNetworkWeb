...
<body class="dark:bg-gray-800 h-screen w-screen">
    ...
    <div class="absolute h-screen w-screen z-10 flex flex-col">
        <header class="relative w-full h-16 flex justify-between">
        ...
        <main class="flex justify-between h-full">
            <div class=" flex flex-col ml-20 mt-28 shadow-xl rounded-2xl bg-white bg-opacity-60 dark:bg-black p-6 pr-2  overflow-y-hidden" style="width: 550px; height: 700px;">
                <div>
                    <p class="text-5xl text-center">KONSTYTUCJA</p>
            ...
            <div class="flex flex-shrink">
                <div class="bg-gray-100 dark:bg-gray-900 mr-14 mt-7 flex-shrink rounded-xl shadow-2xl border dark:border-gray-800 overflow-y-scroll custom-scrollbar" style="height: 800px; width: 900px;">
                    <div class="ml-10 mr-5 pr-5 h-full">
        ...
        <footer class="flex h-24 flex-row-reverse items-center text-sm">

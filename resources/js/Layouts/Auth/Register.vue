                ...
                <div class="ml-10 mr-5 pr-5">
                        ...
                        <div class="flex justify-between">
                            <div>
                                ...
                                <input type="text" name="name" v-model="formData.name"  placeholder="@jankowalski" class="input input-bordered dark:bg-gray-800 w-96">
                                <label class="label">
                                ...
                                <input type="number" min="1900" max="2099" placeholder="np. 2002" class="input input-bordered dark:bg-gray-800 w-96">

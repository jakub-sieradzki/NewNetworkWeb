<template>
  <header class="flex w-full h-14 shadow-md dark:bg-slate-800 flex-shrink-0 bg-gray-100">
    <div class="w-full h-10 self-center relative ml-3 mr-3 lg:ml-4 lg:mr-4">
      ...
      <p class="font-main text-xl absolute top-1/2 left-11 xl:left-0 transform -translate-y-1/2">New Network<span class="text-xs text-gray-400 ml-1">v.0.5.0</span></p>

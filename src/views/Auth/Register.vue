                ...
                <div class="ml-10 mr-5 pr-5">
                        ...
                        <div class="flex justify-between">
                            <div>
                                ...
                                <input type="email" name="email" v-model="formData.email" placeholder="jan.kowalski@example.com" class="input input-bordered dark:bg-gray-800 w-96">
                                <label class="label">
                                    <span class="label-text">Hasło</span>
                                </label>
                                <input type="password" name="password"  v-model="formData.password" placeholder="Hasło" class="input input-bordered dark:bg-gray-800 w-96">
                                <label class="label">
                                    <span class="label-text">Powtórz hasło</span>
                                </label>
                                <input type="password" name="password_confirmation"  v-model="formData.password_confirmation"  placeholder="Hasło" class="input input-bordered dark:bg-gray-800 w-96">
                            </div>
                        ...
                        <div class="flex justify-between">
                            <div>
                                ...
                                <input type="text" v-model="formData.name" placeholder="Jan" class="input input-bordered dark:bg-gray-800 w-96">
                                <label class="label">
                                    <span class="label-text">Nazwisko</span>
                                </label>
                                <input type="text" v-model="formData.surname" placeholder="Kowalski" class="input input-bordered dark:bg-gray-800 w-96">
                                <label class="label">
                                    <span class="label-text">Nazwa użytkownika</span>
                                </label>
                                <input type="text" name="name" v-model="formData.username"  placeholder="jankowalski" class="input input-bordered dark:bg-gray-800 w-96">
                                <label class="label">
                                    <span class="label-text">Płeć</span>
                                </label>
                                <select class="select select-bordered dark:bg-gray-800 w-96" v-model="formData.gender">
                                ...
                                <input type="number" v-model="formData.birthyear" min="1900" max="2099" placeholder="np. 2002" class="input input-bordered dark:bg-gray-800 w-96">
                                ...
                                <div class="h-5"></div>
                                <button class="btn w-96" @click="register">Zarejestruj się</button>
                            </div>
                            <div class="flex flex-col">
                                <div class="w-80 bg-gray-200 dark:bg-gray-800 mt-9 rounded-lg text-xs p-5">

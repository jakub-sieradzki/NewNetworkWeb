                        ...
                        <div class="mx-5">
                            ...
                            <div class="flex justify-between">
                                <div class=" w-full">
                                    ...
                                    <div class="h-5"></div>
                                    <button class="h-10 bg-green-500 hover:bg-green-600 transition-all rounded-lg text-white shadow-lg w-full">Zarejestruj się</button>
                                </div>
                                <div class="flex flex-col hidden md:inline ml-5">
                                    <div class="w-80 text-xs p-5 bg-gray-300 dark:bg-gray-800 mt-9 rounded-lg">
                                        <p>Możesz zmienić swoje imię i nazwisko w każdej chwili w ustawieniach profilu.</p>
...
</html><?php /**PATH D:\Git Hub\NewNetworkWeb\resources\views/register-test.blade.php ENDPATH**/ ?>
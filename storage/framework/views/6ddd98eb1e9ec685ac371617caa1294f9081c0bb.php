            ...
            <main class="flex flex-grow flex-shrink flex-col h-screen md:flex-row items-center md:justify-evenly my-5 px-2 lg:px-20 overflow-x-hidden">
                ...
                <div class="w-full md:w-lg-login rounded-lg shadow-xl border dark:border-gray-800 bg-gray-100 dark:bg-gray-800 p-5 sm:p-7 md:p-11">
                    <div class="flex flex-col">
                        ...
                        <input class="input input-bordered focus:shadow-none mb-2 dark:bg-gray-900" type="email" placeholder="Adres e-mail">
                        <input class="input input-bordered focus:shadow-none mb-2 dark:bg-gray-900" type="password" placeholder="Hasło">
...
</html><?php /**PATH D:\Git Hub\NewNetworkWeb\resources\views/login.blade.php ENDPATH**/ ?>